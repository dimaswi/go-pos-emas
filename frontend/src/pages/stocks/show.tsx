          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0 flex items-center justify-between">
              <div className="min-w-0">
                <CardTitle className="text-sm sm:text-base font-semibold truncate">Detail Stok</CardTitle>
                <CardDescription className="text-[10px] sm:text-xs truncate">Informasi lengkap tentang stok</CardDescription>
              </div>
