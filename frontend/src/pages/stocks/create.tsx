        ...
        <CardHeader className="border-b bg-muted/50 py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <CardTitle className="text-sm sm:text-base font-semibold truncate">Tambah Stok</CardTitle>
              <CardDescription className="text-[10px] sm:text-xs truncate">
                Masukkan detail informasi stok baru
              </CardDescription>
            </div>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button type="submit" size="sm" className="h-9 shrink-0 rounded-lg p-0 w-9 sm:w-auto sm:px-3" disabled={saving || !formData.product_id || !formData.location_id || !formData.storage_box_id}>
                {saving ? (
