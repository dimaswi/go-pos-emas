        ...
        <CardHeader className="border-b bg-muted/50 py-3 sm:py-4 px-3 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <CardTitle className="text-sm sm:text-base font-semibold">Detail Member</CardTitle>
                <CardDescription className="text-[10px] sm:text-xs">Informasi lengkap member</CardDescription>
              </div>
            </div>
