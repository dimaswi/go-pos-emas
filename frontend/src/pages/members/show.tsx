        ...
        <CardHeader className="border-b bg-muted/50 py-3 sm:py-4 px-3 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <CardTitle className="text-sm sm:text-base font-semibold truncate">Detail Member</CardTitle>
              <CardDescription className="text-[10px] sm:text-xs truncate">Informasi lengkap member</CardDescription>
            </div>
