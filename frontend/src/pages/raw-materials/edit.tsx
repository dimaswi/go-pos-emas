        ...
        <CardHeader className="border-b bg-muted/50 py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <CardTitle className="text-sm sm:text-base font-semibold truncate">Edit Bahan Baku</CardTitle>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3 sm:gap-4">
              ...
              <Button type="submit" size="sm" className="h-9 shrink-0 rounded-lg p-0 w-9 sm:w-auto sm:px-3" disabled={loading}>
                ...
                <span className="hidden sm:inline">{loading ? 'Menyimpan...' : 'Simpan Perubahan'}</span>
              </Button>
            </div>
          </form>
        </CardContent>
