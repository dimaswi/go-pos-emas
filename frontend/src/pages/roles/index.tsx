        ...
        <CardHeader className="border-b bg-muted/50 py-3 sm:py-4 px-3 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <CardTitle className="text-sm sm:text-base font-semibold truncate">Roles</CardTitle>
              <CardDescription className="text-[10px] sm:text-xs truncate">
                Manage roles and permissions
              </CardDescription>
            </div>
            {hasPermission("roles.create") && (
              <Button onClick={() => navigate("/roles/create")} size="sm" className="h-9 shrink-0 rounded-lg p-0 w-9 sm:w-auto sm:px-3">
