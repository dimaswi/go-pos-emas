      ...
      <Card className="shadow-md">
        <CardHeader className="border-b bg-muted/50 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-base font-semibold">Edit Kotak Penyimpanan</CardTitle>
              <CardDescription className="text-xs">Perbarui informasi kotak penyimpanan</CardDescription>
            </div>
          </div>
        </CardHeader>
